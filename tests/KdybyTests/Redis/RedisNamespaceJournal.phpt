...
/**
 * Test: Kdyby\Redis\RedisNamespaceJournalTest.
 *
 ...
 * @author Filip Procházka <filip@prochazka.su>
 */
class RedisNamespaceJournalTest extends AbstractRedisTestCase
{
	...
	protected function setUp()
	{
		...
		$this->journal = new RedisLuaJournal($this->getClient(), 'foo');
	}
...
LUA;
		...
		Assert::true($this->getClient()->evalScript($script));
		$this->assertKeysInDatabase(100001);
...
\run(new RedisNamespaceJournalTest());
