...
class ClientsPoolTest extends AbstractRedisTestCase
{
	...
	public function testChooseClient()
	{
		...
		Assert::same($container->getService('redis.client_b6aef3'), $pool->chooseClient('lister')); // md5() ... fe35ce4b4d3b3b45f19df6b7b0669fd9 % 10 ... 4
		Assert::same($container->getService('redis.client_499e3b'), $pool->chooseClient('rimmer')); // md5() ... 4b3db99763faa360c21df8fd384a8d62 % 10 ... 2
		Assert::same($container->getService('redis.client_c22699'), $pool->chooseClient('kryten')); // md5() ... 255bd87dfe66e24f6f25147b0d7dd948 % 10 ... 8
	}
